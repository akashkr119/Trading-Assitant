...
def _render_live_selected_coin(
    ...
    st.caption(
        f"{passed}/{total} live core conditions confirmed · 1H confirmation shown separately"
    )
    ...
    if candidate.score >= 75:
        ...
        st.caption(
            "Signal generated by the scan. This trade plan remains fixed until a new scan "
...
if candidates:
    ...
    # Never allow a stale/invalid widget value to reach candidate lookup.
